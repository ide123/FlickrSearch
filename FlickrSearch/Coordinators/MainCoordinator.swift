...
class MainCoordinator : NSObject, CoordinatorProtocol, UINavigationControllerDelegate {
    ...
    func start() {
        ...
        /// The SearchViewModel is initialised with a SearchModel. The View Controller is instantiated from a Nib and initialised with the SearchViewModel  and  a Coordinator . This sets up the dependencies correctly and
